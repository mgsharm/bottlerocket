...
%package aws-k8s-1.34-amd
Summary: Settings defaults for the aws-k8s 1.34 amd variant
Requires: %{_cross_os}variant(aws-k8s-1.34-amd)
Provides: %{_cross_os}settings-defaults(any)
Provides: %{_cross_os}settings-defaults(aws-k8s-1.34-amd)
Conflicts: %{_cross_os}settings-defaults(any)

%description aws-k8s-1.34-amd
%{summary}.
...
%files aws-k8s-1.34-amd
%{_cross_defaultsdir}/aws-k8s-1.34-amd.toml
%{_cross_tmpfilesdir}/storewolf-defaults-aws-k8s-1.34-amd.conf
